...
function Proposition() {
  return (
    <div className="section_proposition_all">
            ...
            <Fade direction="left">
              <div className="proposition_content_item_block">
                ...
                <div className="proposition_content_item_title">
                  <h3>DUI/UX DESIGN</h3>
                  <p>
                    Je suis capable de vous fournir un design unique, je sais
                    gérer plusieurs support pour le maquettage de site ou
                    application web. Egalement je peux vous faire le design de
                    flyers ou publicité.
                  </p>
                </div>
              </div>
              ...
              <div className="proposition_content_item_block">
                ...
                <div className="proposition_content_item_title">
                  ...
                  <p>
                    ...
                    tarif adapté à vos besoins. Un site web doit vous
                    représenter, il doit marquer les esprits !
                  </p>
                </div>
              </div>
            </Fade>
              ...
              <div className="proposition_content_item_block">
                ...
                <div className="proposition_content_item_title">
                  ...
                  <p>
                    ...
                    davantage d'utilisateurs mobiles, je peux vous aider à
                    concevoir et à construire une plate-forme avec l'apparence
                    la plus récente et la plus tendance.
                  </p>
                </div>
              </div>
            </Fade>
            <Fade direction="right">
              <div className="proposition_content_item_block">
                ...
                <div className="proposition_content_item_title">
                  ...
                  <p>
                    Car la sécurité est très important de nos jours, aussi bien
                    pour vous que pour les personnes venant sur votre site. Je
                    met un point d'honneur à vous former dessus, et sécuriser le
                    site pour que les données des utilisateurs ne soient pas
                    récupérable par n'importe qui.
                  </p>
                </div>
              </div>
            </Fade>
