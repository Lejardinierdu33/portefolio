...
function Skills() {
  ...
  return (
    <div className="section_all_skills">
          ...
          <div className="section_allexp">
            ...
            <div className="section_exp">
              ...
              <div className="section_exp_right">
                ...
                <p>
                  Gestion projet, mise en ligne de site internet pour des
                  clients. Mise en place d'application mobile (avec Flutter) de
                  sites e-commerce. Utilisation de différent framework.
                </p>
              </div>
            </div>
            <div className="section_exp">
